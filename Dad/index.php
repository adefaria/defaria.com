...
//Title of your guestbook
  $title = "Memorial for Carlos Gomes De Faria";
//Change "admin" with your own password. It's required when you delete an entry
  $admin_password = "teafor6265";
//Enter your email here
  $admin_email = "Andrew@DeFaria.com";
//Your website URL
  $home = "http://defaria.com";
...
?>
   ...
   <font size="2" color="<?=$title_color?>"><b><a href="indexp.php"><font color="<?=$title_color?>">Portuguese</font></a></b></font><br><br></center>

<table border=0 cellspacing=0 cellpadding=3 align=right>
<tbody>
<tr>
<td>
<a href="/gallery/main.php?g2_view=core.ShowItem&g2_itemId=3424"><img align="right" src="/Images/Dad.jpg" border=0 width=200 height=240></a>
</td>
</tr>
<td align=center>
<font size="2" color=white><a href="/gallery/main.php?g2_view=core.ShowItem&g2_itemId=3424">More photos added 4/25/2006<br>Click here</font></a>
</td>
</tr>
</tbody>
</table>

<font size="2" color=white><p><a href="/gallery/main.php?g2_view=core.ShowItem&g2_itemId=3424"><b>Charles Gomes De Faria</b></a> age 81,
passed away on March 19, 2006 in Santos Brazil. Originally from Newark
N.J.he served in the Army in WWII under General Patton's command. He
recieved an honorable discharge. He later married and moved to Linden
N.J.had 5 children.. He moved to Santos, Brazil in 1970 and has
lived there the remainder of his life</p>

<p>He leaves behind his companion Hilda and his 5 children from his
former marriage. Roxanne Johansen from Oldsmar Fl, Raymond De Faria
from Clearwater Fl, Christina De Faria from Lawrenceville Ga , Andrew
De Faria from San Jose Ca.and Cindy Anderson from.Oviedo Fl. He also
leaves 5 grandchildren his only sister Mrs. Mary Arminio from W. Palm
Beach Fl and a niece Diane Perry from Port St. Lucie and 3 Great
neices.</p>

<p>He will be missed very much by the entire family. A Memorial Mass
will be held for him at St. Lukes Catholic Church in Palm Springs,
Florida on April 23, 2006.</p>

<p>If you would want you can leave any comment you would like below.</p>

   <table width="600" cellpadding="0" cellspacing="1" border="0" align=center>
   <tr bgcolor="<?=$table_border?>">
   <td>
      <table width="100%" cellpadding="4" cellspacing="1" border="0">
      <tr>
	    <td bgcolor="<?=$table_top?>" colspan="3" width="100%">
           <font size="2" color="#ffffff"><b>Click <a href="<?="$self?do=add_form&page=$page"?>">here</a> to sign the memorial</font></b>
        </td>
	  </tr>
<?
