...
<head>
  ...
  <title>Jokes: Ode to Spell Checker</title>
...
<div class="heading">
  <h1 class="centered">Ode to Spell Checker</h1>
  <div class="box">
    <?php oneliner ("no")?>
  </div>
</div>
