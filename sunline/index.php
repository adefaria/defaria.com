...
<div class="heading">
  <h1 class="centered">A run in with Sunline Energy</h1>
</div>

<div id="content">
  <?php navigation_bar ()?>

  <h2>A run in with Sunline Energy</h2>
  ...
  job for his company, that it would just be the estimate. Sorry but for all I know the
  sellers may take that estimate and hire your company. Or I may hire your company down
  the road too. The point is you should provide the estimate, not a text message.</p>

  <p>He said that they take the satellite images to do the inspection so they don't risk
  breaking any of the concrete tiles. I didn't know satellite images were that detailed.
  Jacob said he would email me with the results.</p>
  ...
  that the roof needs replacing. Feel free to call him up and ask why he's doing this.</p>

  <p>What a slimeball! Let's see what other rating sites I can spread this message to...</p>
